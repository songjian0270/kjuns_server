...
public class AlipayNotify {
    ...
    public static boolean verify(Map<String, Object> params) {
		...
		if(params.get("notify_id") != null) {
			System.out.println("alipay notify_id not null");
	    ...
	    if(params.get("sign") != null) {
			System.out.println("alipay sign not false");
     ...
     * @return 生成的签名结果
     */
	private static boolean getRSASignVerify(Map<String, Object> Params, String sign) {
        ...
        try {
			isSign = AlipaySignature.rsaCheckContent(
					preSignStr, sign, SysConf.ALI_PUBLIC_SECRET,
    ...
    */
    private static String verifyResponse(String notify_id) {
        ...
        String partner = SysConf.ALI_PARTNER_ID;
